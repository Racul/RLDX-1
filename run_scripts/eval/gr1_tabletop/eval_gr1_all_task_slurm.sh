...
#SBATCH --output=/data/home/james1990a/rldx_eval/gr1_tabletop/slurm/%x-%j.out

# Full GR-1 Tabletop eval on a GPU compute node: serve RLDX-1 once, then roll out
# all 24 tabletop tasks (18 object-rearrangement + 6 articulated), recording an
# mp4 video per task.
#
# Everything goes to /data (1TB), never the /data_fast SSD:
#   - videos + per-task logs : /data/home/james1990a/rldx_eval/gr1_tabletop/<label>/<task>/
#   - HF checkpoint download  : /data/home/james1990a/.cache/huggingface  (HF_HOME)
#   - slurm job log           : /data/home/james1990a/rldx_eval/gr1_tabletop/slurm/%x-%j.out
#
...
#   mkdir -p /data/home/james1990a/rldx_eval/gr1_tabletop/slurm
#   sbatch run_scripts/eval/gr1_tabletop/eval_gr1_all_task_slurm.sh [RUN_LABEL] [MODEL_PATH]
...
RUN_LABEL="${1:-gr1_all_eval}"
MODEL_PATH="${2:-RLWRLD/RLDX-1-FT-GR1}"
...
OUT_ROOT="/data/home/james1990a/rldx_eval/gr1_tabletop"
